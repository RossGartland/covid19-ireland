    ...
    return (
        <div>
            ...
            <Accordion q1={'Going to work'} a1={'You should work from home unless it is impossible for you to do so.' +
                ...
                q3={'Sick pay'} a3={'You can get £94.25 per week Statutory Sick Pay (SSP) if you’re too ill to work. It’s paid by your employer for up to 28 weeks.' +
                ...
                q4={'Proof of sickness'} a4={'If you have COVID-19 or are advised to stay at home, you can get an ‘isolation note’ by visiting NHS 111 online, rather than visiting a doctor. For COVID-19 cases this replaces the usual need to provide a ‘fit note’ (sometimes called a ‘sick note’) after 7 days of sickness absence.'}
                q5={'If you’re self-employed or not eligible for SSP'}
                a5={'If you are not eligible for SSP – for example if you are self-employed or earning below the Lower Earnings Limit of £118 per week – and you have COVID-19 or are advised to stay at home, you can now more easily make a claim for Universal Credit or new style Employment and Support Allowance.' +
